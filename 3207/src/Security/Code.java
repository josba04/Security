...
public class Code {
	...
	public static String strcopy = "0";
	public static void main(String[] args) {
		...
		@Override
			public void actionPerformed(ActionEvent e) {
				key = f.getTextField().getText();			//key 입력

				strcopy =  f.getTextField2().getText(); 	//문자열 입력
		...
		for( int i = 0 ; i < alphabetBoard.length ; i++ )
		{
			...
			{
				f.area3.append(String.valueOf(alphabetBoard[i][j]) + " - " );
		...
		f.button3.addActionListener(new ActionListener(){	
			
			@Override
				public void actionPerformed(ActionEvent e) {
				
				f.CodeFrame4();
				f.area4.append(encryption);
					
				f.button4.addActionListener(new ActionListener(){	
									
									@Override
										public void actionPerformed(ActionEvent e) {
										
											f.CodeFrame5();
											f.area5.append(decryption);
											
											f.button5.addActionListener(new ActionListener(){	
